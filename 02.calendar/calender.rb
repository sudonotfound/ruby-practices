...
=end
# 日付を表示
(first_day..last_day).each do |date| #first_day から last_day までの日付の範囲をイテレートします。各日付オブジェクトを date として順に処理
  printf("%2d ", date.day) #文字列の「左寄せ」や、数値の「桁のゼロ埋め」や、「小数点以下の桁指定」など、出力する文字列のフォーマットを指定したいときに使用
